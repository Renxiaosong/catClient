...
public class HttpTools {
    ...
    public static com.wiseweb.json.JSONObject getData(HttpClient client,String url) throws ClientProtocolException, IOException {
        com.wiseweb.json.JSONObject Cookie = new com.wiseweb.json.JSONObject();
        com.wiseweb.json.JSONObject form = new com.wiseweb.json.JSONObject();
        com.wiseweb.json.JSONObject h = new com.wiseweb.json.JSONObject();
